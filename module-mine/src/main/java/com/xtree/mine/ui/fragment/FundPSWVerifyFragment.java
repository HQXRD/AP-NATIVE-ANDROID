...
public class FundPSWVerifyFragment extends BottomPopupView {
    ...
    public static FundPSWVerifyFragment newInstance(Context context, LifecycleOwner owner, FundPSWVerifyFragment.IFundPWVerifyCallBack iFundPassWordCallBack) {
