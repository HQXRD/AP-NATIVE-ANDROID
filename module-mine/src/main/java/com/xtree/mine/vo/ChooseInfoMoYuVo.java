...
public class ChooseInfoMoYuVo {
	...
	*/
    ...
    public  String check ;//下一个接口使用的CheckCode
    ...
    */
    public ChooseInfoVo.Info usdtInfo ;
    public ChooseInfoVo.User user ;
    /**
     * 可使用支付渠道list
     */
    public ArrayList<ChooseInfoVo.ChannelInfo> wdChannelList ;
    ...
    */
        ...
        public String availablebalance ;//用户余额
