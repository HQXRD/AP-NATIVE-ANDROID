...
public class ExTransferPayeeUploadComponent implements Component {

    /**
     *充值 确认付款 等待到账 引导页面 页面点击回调
     * */
    public interface  IExTransferPayeeUploadCallback{
        /**
         * 上一步
         */
    ...
    private IExTransferPayeeUploadCallback iExTransferPayeeCallback ;
    public ExTransferPayeeUploadComponent(IExTransferPayeeUploadCallback iExTransferPayeeCallback){
        super();
        this.iExTransferPayeeCallback = iExTransferPayeeCallback ;
    }
    @Override
    public View getView(LayoutInflater inflater) {
        LinearLayout ll = (LinearLayout) inflater.inflate(R.layout.guide_ex_transfer_payee_item, null);
