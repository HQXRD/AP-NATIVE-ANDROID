...
public class ExTransferPayeeSureComponent implements Component {
    ...
    public ExTransferPayeeSureComponent(IExTransferPayeeUploadCallback iExTransferPayeeCallback){
        super();
