...
public class RechargeTypeAdapter extends CachedAutoRefreshAdapter<PaymentTypeVo> {
    ...
    public void onBindViewHolder(@NonNull CacheViewHolder holder, int position) {
        ...
        Glide.with(ctx).load(url).placeholder(R.mipmap.rc_ic_pmt_happy).into(binding.ivwIcon);
    ...
    private void setItemStatus(View view, boolean isSelected) {
        ...
        Glide.with(ctx).load(url).placeholder(R.mipmap.rc_ic_pmt_happy).into(binding2.ivwIcon);
    }
