...
public abstract class FixHttpCallBack<T> extends DisposableSubscriber<T> {
    public abstract void onResult(T t,BusinessException ex);
    ...
    public void onNext(T o) {
        ...
        switch (status) {
            case FixHttpCallBack.CodeRule.CODE_0:
            case FixHttpCallBack.CodeRule.CODE_10000:
                ...
                break;
            case FixHttpCallBack.CodeRule.CODE_300:
                //请求失败，不打印Message
                KLog.e("请求失败");
                ToastUtils.showShort("错误代码:", baseResponse.getStatus());
                break;
            case FixHttpCallBack.CodeRule.CODE_330:
                //请求失败，打印Message
                ToastUtils.showShort(baseResponse.getMessage());
                break;
            case FixHttpCallBack.CodeRule.CODE_500:
                //服务器内部异常
                ToastUtils.showShort("错误代码:", baseResponse.getStatus());
                break;
            case FixHttpCallBack.CodeRule.CODE_503:
                //参数为空
                KLog.e("参数为空");
                break;
            case FixHttpCallBack.CodeRule.CODE_502:
                //没有数据
                KLog.e("没有数据");
                break;
            ...
            case FixHttpCallBack.CodeRule.CODE_20101:
            case FixHttpCallBack.CodeRule.CODE_20102:
            case FixHttpCallBack.CodeRule.CODE_20103:
            case FixHttpCallBack.CodeRule.CODE_20106:
            case FixHttpCallBack.CodeRule.CODE_20107:
            case FixHttpCallBack.CodeRule.CODE_20217:
            case FixHttpCallBack.CodeRule.CODE_20111:
            case FixHttpCallBack.CodeRule.CODE_30003:
            case FixHttpCallBack.CodeRule.CODE_30713:
                ...
                break;
            case FixHttpCallBack.CodeRule.CODE_20208:
            case FixHttpCallBack.CodeRule.CODE_30018:
                // 异地登录/换设备登录
                // 谷歌验证
                onFail(ex);
                break;
