...
public class SpecialMenuItemView extends BaseTabItem {
    ...
    public SpecialMenuItemView(Context context) {
        this(context, null);
    }

    public SpecialMenuItemView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SpecialMenuItemView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        LayoutInflater.from(context).inflate(R.layout.special_item_menu, this, true);
